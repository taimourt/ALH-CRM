...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900/60 text-slate-950 dark:text-slate-50 shadow-sm backdrop-blur-xs transition-all',
        className
      )}
      {...props}
    />
